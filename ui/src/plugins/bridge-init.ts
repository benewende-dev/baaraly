 ...
 *
 * This is placed on `globalThis.__baaraliPluginBridge__` and consumed by
...
declare global {
  ...
  var __baaraliPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__baaraliPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__baaraliPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
