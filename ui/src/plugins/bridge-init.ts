 ...
 *
 * This is placed on `globalThis.__baaralyPluginBridge__` and consumed by
...
declare global {
  ...
  var __baaralyPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__baaralyPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__baaralyPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
