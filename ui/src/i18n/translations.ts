...
export const translations: Record<string, Record<Language, string>> = {
  ...
  "prospects/jour": { fr: "prospects/jour", en: "prospects/day" },
  "Sans carte bancaire": { fr: "Sans carte bancaire", en: "No credit card required" },
  "En ligne": { fr: "En ligne", en: "Online" },
  "J'ai trouvé 5 nouveaux prospects aujourd'hui !": { fr: "J'ai trouvé 5 nouveaux prospects aujourd'hui !", en: "I found 5 new prospects today!" },
  "3 ont répondu positivement": { fr: "3 ont répondu positivement", en: "3 responded positively" },
  "Super ! Envoie-moi le rapport": { fr: "Super ! Envoie-moi le rapport", en: "Great! Send me the report" },
  "Voilà, c'est fait ! 📊": { fr: "Voilà, c'est fait ! 📊", en: "Done! 📊" },
  "Le problème": { fr: "Le problème", en: "The problem" },
  "Tu en as assez de tout faire tout seul ?": { fr: "Tu en as assez de tout faire tout seul ?", en: "Tired of doing everything yourself?" },
  "Répondre aux clients WhatsApp à toute heure": { fr: "Répondre aux clients WhatsApp à toute heure", en: "Answering WhatsApp clients at all hours" },
  "Tu passes tes nuits à répondre aux messages au lieu de dormir": { fr: "Tu passes tes nuits à répondre aux messages au lieu de dormir", en: "You spend your nights answering messages instead of sleeping" },
  "Tenir ta comptabilité et gérer ton stock": { fr: "Tenir ta comptabilité et gérer ton stock", en: "Managing your accounting and inventory" },
  ...
  "Boutique, agriculture, services... Dis-nous ce que tu fais": { fr: "Boutique, agriculture, services... Dis-nous ce que tu fais", en: "Shop, agriculture, services... Tell us what you do" },
  "Tu choisis tes agents": { fr: "Tu choisis tes agents", en: "Choose your agents" },
  "Des assistants spécialisés dans ton domaine": { fr: "Des assistants spécialisés dans ton domaine", en: "Specialized assistants in your field" },
  "Ils travaillent, tu encaisses": { fr: "Ils travaillent, tu encaisses", en: "They work, you earn" },
  "Ton équipe digitale est opérationnelle 24h/24": { fr: "Ton équipe digitale est opérationnelle 24h/24", en: "Your digital team is operational 24/7" },
  "Tes agents": { fr: "Tes agents", en: "Your agents" },
  "Tes nouveaux employés digitaux": { fr: "Tes nouveaux employés digitaux", en: "Your new digital employees" },
  "Et bien d'autres agents spécialisés pour tous les secteurs d'activité.": { fr: "Et bien d'autres agents spécialisés pour tous les secteurs d'activité.", en: "And many more specialized agents for all sectors." },
  "Découvrir tous les agents": { fr: "Découvrir tous les agents", en: "Discover all agents" },
  "Témoignages": { fr: "Témoignages", en: "Testimonials" },
  "Ce qu'ils disent": { fr: "Ce qu'ils disent", en: "What they say" },
  "Aminata répond à mes clients WhatsApp même la nuit. J'ai gagné 3 heures par jour.": {
    fr: "Aminata répond à mes clients WhatsApp même la nuit. J'ai gagné 3 heures par jour.",
    en: "Aminata answers my WhatsApp clients even at night. I saved 3 hours a day.",
  },
  "Sékou me donne les prix du marché chaque matin. Je vends mieux qu'avant.": {
    fr: "Sékou me donne les prix du marché chaque matin. Je vends mieux qu'avant.",
    en: "Sékou gives me market prices every morning. I sell better than before.",
  },
  "Ibrahim gère ma comptabilité OHADA. Mon comptable est moins stressé.": {
    fr: "Ibrahim gère ma comptabilité OHADA. Mon comptable est moins stressé.",
    en: "Ibrahim manages my OHADA accounting. My accountant is less stressed.",
  },
  "Tarifs": { fr: "Tarifs", en: "Pricing" },
  "Un prix juste pour chaque étape": { fr: "Un prix juste pour chaque étape", en: "A fair price for every stage" },
  "Populaire": { fr: "Populaire", en: "Popular" },
  "Commencer gratuitement": { fr: "Commencer gratuitement", en: "Start for free" },
  "Choisir Pro": { fr: "Choisir Pro", en: "Choose Pro" },
  "Choisir Max": { fr: "Choisir Max", en: "Choose Max" },
  "Voir tous les détails": { fr: "Voir tous les détails", en: "See all details" },
  "Connecte WhatsApp en 2 minutes": { fr: "Connecte WhatsApp en 2 minutes", en: "Connect WhatsApp in 2 minutes" },
  "Tes agents répondent à tes clients directement sur WhatsApp. Pas d'app à installer. Pas de formation.": {
    fr: "Tes agents répondent à tes clients directement sur WhatsApp. Pas d'app à installer. Pas de formation.",
    en: "Your agents answer your clients directly on WhatsApp. No app to install. No training needed.",
  },
  ...
  "Aucune carte bancaire n'est requise.": { fr: "Aucune carte bancaire n'est requise.", en: "No credit card required." },
  "Est-ce que c'est vraiment automatique ?": { fr: "Est-ce que c'est vraiment automatique ?", en: "Is it really automatic?" },
  "Oui. Une fois configuré, ton agent travaille 24h/24 sans intervention de ta part. Tu reçois les résultats sur WhatsApp et dans ton dashboard.": {
    fr: "Oui. Une fois configuré, ton agent travaille 24h/24 sans intervention de ta part. Tu reçois les résultats sur WhatsApp et dans ton dashboard.",
    en: "Yes. Once configured, your agent works 24/7 without your intervention. You receive results on WhatsApp and in your dashboard.",
  },
  "Comment je paie ?": { fr: "Comment je paie ?", en: "How do I pay?" },
  "Tu recharges ton compte. Pas d'abonnement obligatoire. Paiement via Orange Money, Wave, MTN, Moov, M-Pesa, Stripe, PayPal ou Crypto.": {
    fr: "Tu recharges ton compte. Pas d'abonnement obligatoire. Paiement via Orange Money, Wave, MTN, Moov, M-Pesa, Stripe, PayPal ou Crypto.",
  ...
  "L'IA qui fait prospérer ton entreprise": { fr: "L'IA qui fait prospérer ton entreprise", en: "AI that grows your business" },
  "Accueil": { fr: "Accueil", en: "Home" },
  "Contact": { fr: "Contact", en: "Contact" },

  // ── Pricing page ─────────────────────────────────────────────────────────
  "Choisis ton équipe digitale": { fr: "Choisis ton équipe digitale", en: "Choose your digital team" },
  "Des agents IA qui travaillent pour toi 24h/24, 7j/7. Commence gratuitement.": {
    fr: "Des agents IA qui travaillent pour toi 24h/24, 7j/7. Commence gratuitement.",
    en: "AI agents that work for you 24/7. Start for free.",
  },
  "Mensuel": { fr: "Mensuel", en: "Monthly" },
  "Annuel": { fr: "Annuel", en: "Annual" },
  "jours gratuits": { fr: "jours gratuits", en: "free days" },
  "Illimité": { fr: "Illimité", en: "Unlimited" },
  "agents": { fr: "agents", en: "agents" },
  "FCFA/mois": { fr: "FCFA/mois", en: "FCFA/month" },
  "Soit": { fr: "Soit", en: "That's" },
  "jour": { fr: "jour", en: "day" },
  "crédits inclus/mois": { fr: "crédits inclus/mois", en: "credits included/month" },
  "Choisir": { fr: "Choisir", en: "Choose" },
  "Paiement sécurisé": { fr: "Paiement sécurisé", en: "Secure payment" },
  "Orange Money · Wave · Moov · MTN · Carte bancaire": { fr: "Orange Money · Wave · Moov · MTN · Carte bancaire", en: "Orange Money · Wave · Moov · MTN · Credit card" },
  "Une question ?": { fr: "Une question ?", en: "A question?" },
  "Contacte-nous": { fr: "Contacte-nous", en: "Contact us" },
  "1 agent Standard": { fr: "1 agent Standard", en: "1 Standard agent" },
  "WhatsApp inclus": { fr: "WhatsApp inclus", en: "WhatsApp included" },
  "Dashboard basique": { fr: "Dashboard basique", en: "Basic dashboard" },
  "Support email": { fr: "Support email", en: "Email support" },
  "10 agents (Standard + Avancé)": { fr: "10 agents (Standard + Avancé)", en: "10 agents (Standard + Advanced)" },
  "Multi WhatsApp": { fr: "Multi WhatsApp", en: "Multi WhatsApp" },
  "Rapports avancés": { fr: "Rapports avancés", en: "Advanced reports" },
  "Support prioritaire": { fr: "Support prioritaire", en: "Priority support" },
  "Agents Finance, Commerce, Conformité": { fr: "Agents Finance, Commerce, Conformité", en: "Finance, Commerce, Compliance agents" },
  "Tous les agents disponibles": { fr: "Tous les agents disponibles", en: "All agents available" },
  "API access": { fr: "API access", en: "API access" },
  "Multi-entreprise": { fr: "Multi-entreprise", en: "Multi-company" },
  "Support dédié": { fr: "Support dédié", en: "Dedicated support" },
  "Agents premium inclus": { fr: "Agents premium inclus", en: "Premium agents included" },
  "Recharger": { fr: "Recharger", en: "Top up" },
  "crédits": { fr: "crédits", en: "credits" },
  "Crédits épuisés": { fr: "Crédits épuisés", en: "Credits exhausted" },
  "Bientôt épuisé": { fr: "Bientôt épuisé", en: "Running low" },
  "Recharger mes crédits": { fr: "Recharger mes crédits", en: "Top up my credits" },
  "Méthode de paiement": { fr: "Méthode de paiement", en: "Payment method" },
  "Traitement...": { fr: "Traitement...", en: "Processing..." },
  "Payer et recharger": { fr: "Payer et recharger", en: "Pay and top up" },
  "Crédits ajoutés": { fr: "Crédits ajoutés", en: "Credits added" },
  "crédits ajoutés à votre solde": { fr: "crédits ajoutés à votre solde", en: "credits added to your balance" },
  "Erreur": { fr: "Erreur", en: "Error" },
  "Choisis une méthode de paiement": { fr: "Choisis une méthode de paiement", en: "Choose a payment method" },
};
